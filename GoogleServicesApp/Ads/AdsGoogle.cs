...
namespace GoogleServicesApp.Ads
{
    public static class AdsGoogle
    {
        ...
        private abstract class AdMobInterstitial : InterstitialAdLoadCallback
        { 
        ...
        private class AppOpenManager : AppOpenAd.AppOpenAdLoadCallback
        {
            ...
            public bool IsAdExpired()
            {
                try
                {
                    return CurrentTimeMillis() - LastAdFetchTime > AdExpiryDuration;
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
            ...
            public void ShowAdIfAvailable(FullScreenContentCallback listener)
            {
                try
                {
                    ...
                    Ad.FullScreenContentCallback = new MyFullScreenContentCallback(this, listener);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
